...
public class Order {
    ...
    public Order(UUID id, String description, Client client, Mechanic mechanic, Timestamp creature, Timestamp completion, int price, Status status) {
        this.id = id;
    ...
    public Order(UUID id, String description, Client client, Mechanic mechanic, Timestamp creature, int price, Status status) {
        this.id = id;
        this.description = description;
        this.client = client;
        this.mechanic = mechanic;
